...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"src/homeCarousel.js":[function(require,module,exports) {
"use strict";
...
var slideEase = "power3.inOut";

var carousels = _gsap.default.utils.toArray(".home__people__carousel");

var carouselPrevButton = document.querySelector(".home__people__prev");
var carouselNextButton = document.querySelector(".home__people__next");
carousels.forEach(function (carousel) {
  var slides = carousel.querySelectorAll(".home__people__carousel__slide");

  var progressWrap = _gsap.default.utils.wrap(0, 1);

  var numSlides = slides.length;
  var startingSlide = carousel.dataset.start || 0;
  var snapX;

  _gsap.default.set(slides, {
    xPercent: function xPercent(i) {
      return i * 100 - 100 * startingSlide;
    }
  });

  var wrap = _gsap.default.utils.wrap(-100, (numSlides - 1) * 100);

  var timer = _gsap.default.delayedCall(slideDelay, autoPlay);

  var animation = _gsap.default.to(slides, {
  ...
  var slideAnimation = _gsap.default.to({}, {});
  ...
  function animateSlides(direction) {
    timer.restart(true);
    slideAnimation.kill();
    var x = snapX(_gsap.default.getProperty(proxy, "x") + direction * slideWidth);
    slideAnimation = _gsap.default.to(proxy, {
      x: x,
  ...
  function updateProgress() {
    animation.progress(progressWrap(_gsap.default.getProperty(proxy, "x") / wrapWidth));
  }

  function resize() {
    var norm = _gsap.default.getProperty(proxy, "x") / wrapWidth || 0;
    slideWidth = slides[0].offsetWidth;
    wrapWidth = slideWidth * numSlides;
    snapX = _gsap.default.utils.snap(slideWidth);

    _gsap.default.set(proxy, {
      x: norm * wrapWidth
    });
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/homeCarousel.js"], null)
//# sourceMappingURL=/homeCarousel.e596125c.js.map